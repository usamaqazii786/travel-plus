                  ...
                  <Card>
                    <CardBody className="p-0 bg-black auth-header-box rounded-top">
                      <div className="text-center p-3">
                        <Link to="/agentdashboard" className="logo logo-admin">
                          <img src={logoSm} loading="lazy"  height={50} width={50} alt="logo" className="auth-logo" />
                        </Link>
                        <h4 className="mt-3 mb-1 fw-semibold text-white fs-18">Oops! Sorry page does not found</h4>
                        <p className="text-muted fw-medium mb-0">Back to dashboard of Travel+</p>
                      </div>
                    </CardBody>
                    <CardBody className="pt-0">
                      ...
                      <Link to="/agentdashboard" className="btn btn-primary w-100">
