...
import { EditPromotionService } from '@/utils/Services/PromotionServices'
...
export default function EditPromotion() {
  ...
  const onSubmit = (data) => {
    EditPromotionService(data, navigate, showNotification, setloading, id)
  }
