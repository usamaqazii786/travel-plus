...
// import { TestimonialDelete } from '@/utils/Services/TestimonialServices'

const TestimonialTable = ({ Testimonial }) => {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-start">
          <span role="button" onClick={() => navigate(`/dashboard/${name}/Testimonial-section/addTestimonial`, { state: row.original })}>
            <IconifyIcon icon="la:pen" className="text-secondary fs-18" />
          </span>
          {/* <span role="button" onClick={() => TestimonialDelete(setloading, row?.original?.id, showNotification, setTestimonial)}>
