          ...
          <Col lg={5} className="offset-lg-1 align-self-center">
            <div className="p-3">
              ...
              <h1 className="my-4 font-weight-bold">
                Manage Your Work With <span className="text-primary">Travel+</span>.
              </h1>
              <p className="fs-14 text-muted">
                Travel+ is a Bootstrap 5 admin dashboard, It is fully responsive and included awesome features to help build web applications fast and
                easy.
              </p>
