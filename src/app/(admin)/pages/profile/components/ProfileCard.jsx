          ...
          <Col lg={4} className="align-self-center mb-3 mb-lg-0">
            <div className="d-flex align-items-center flex-row flex-wrap">
              <div className="position-relative me-3">
                <img src={user?.image || '/public/assets/profile.png'} alt="avatar" height={120} className="rounded-circle" />
              ...
              <div>
                <h5 className="fw-semibold fs-22 mb-1">{`${user?.fname} ${user?.lname}`}</h5>
                <p className="mb-0 text-muted fw-medium">{user?.city}</p>
              </div>
            </div>
          </Col>
          ...
          <Col lg={4} className="align-self-center">
            <Row className="row-cols-2">
              <Col className="text-end">
                <CompletionChart percentage={user?.percentage} />
              </Col>
