          ...
          <Tab
            ...
            title={
              <>
                ...
                <span className="badge bg-primary-subtle text-primary badge-pill ms-1 text-dark">24</span>
              </>
            }>
              ...
              {notificationsData.map((notification, idx) => (
                <DropdownItem href="" className="py-3" key={idx}>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="flex-shrink-0 bg-primary-subtle text-dark thumb-md rounded-circle">
                      <IconifyIcon icon={notification.icon} className="fs-4" />
                    </div>
                    <div className="flex-grow-1 ms-2 ">
                      <h6 className="my-0 fw-normal text-dark fs-13" style={{ textWrap: 'auto' }}>
                        {notification.title}
                      </h6>
